...
public enum Enum_HW {
    ...
    private static void getDay() {
        ...
        for (int i = 0; i < Enum_HW.values().length; i++) {
            ...
            System.out.println("your trip to Munich by " + Enum_HW.values()[i]
                                               + " will last" + day1 + " days");
        }
    ...
    public static void getHourMethod() {
        for (int i = 0; i < Enum_HW.values().length; i++) {
            System.out.println("your trip to Munich by " + Enum_HW.values()[i] + " will last "
                                + Enum_HW.values()[i].getHour() + "  hours");
        }
